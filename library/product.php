...
function get_0_200()
{
	$sql = "SELECT * FROM sanpham where trangthai =1 and gia between 0 and 200000 ";
	$result = db_fetch_array($sql);
	return $result;
}
function get_200_600()
{
	$sql = "SELECT * FROM sanpham where trangthai =1 and gia between 200000 and 600000 ";
	$result = db_fetch_array($sql);
	return $result;
}
function get_600_1200()
{
	$sql = "SELECT * FROM sanpham where trangthai =1 and gia between 600000 and 1200000 ";
	$result = db_fetch_array($sql);
	return $result;
}
function get_1200_2000()
{
	$sql = "SELECT * FROM sanpham where trangthai =1 and gia between 1200000 and 2000000 ";
	$result = db_fetch_array($sql);
	return $result;
}
function get_2000_plus()
{
	$sql = "SELECT * FROM sanpham where trangthai =1 and gia > 2000000 ";
	$result = db_fetch_array($sql);
	return $result;
}
...
function get_product_0_200($start, $num_per_page, $id_loai)
{
	...
	$result = db_fetch_array("SELECT * FROM sanpham where trangthai =1 and maloai=$id_loai and gia between 0 and 200000 LIMIT {$start}, {$num_per_page}");
	return $result;
}
function get_product_200_600($start, $num_per_page, $id_loai)
{

	$result = db_fetch_array("SELECT * FROM sanpham where trangthai =1 and maloai=$id_loai and gia between 200000 and 600000 LIMIT {$start}, {$num_per_page}");
	return $result;
}
function get_product_600_1200($start, $num_per_page, $id_loai)
{

	$result = db_fetch_array("SELECT * FROM sanpham where trangthai =1 and maloai=$id_loai and gia between 600000 and 1200000 LIMIT {$start}, {$num_per_page}");
	return $result;
}
function get_product_1200_2000($start, $num_per_page, $id_loai)
{

	$result = db_fetch_array("SELECT * FROM sanpham where trangthai =1 and maloai=$id_loai and gia between 1200000 and 2000000 LIMIT {$start}, {$num_per_page}");
	return $result;
}
