                                ...
                                <table class="table-shopping-cart">
                                    ...
                                    ?>
                                        <tr class="table-row">
                                            ...
                                            <td class="column-3 " id="gia_<?php echo $item['id']; ?>" value="<?php echo $item['gia'] ?>"><?php echo $item['gia'] ?> VND </td>
                                            <td class="column-4">
                                            ...
                                            <span class="input-group-btn">
                                                ...
                                                <script>
                                                    function updateItem(id) {
                                                        ...
                                                        sl++;
                                                        // alert(sl);
                                                        gia = VND("#gia_" + id).html();
                                                        total = sl * gia.slice(1, 10);
                                                        VND('#total_' + id).html('VND' + total);
                                                        console.log(total)
                                                    }
                                            ...
                                            <td class="column-5" id="total_<?php echo $item['id']; ?>"><?php echo $item['sub_total'] ?> VND </td>
                                        </tr>
                                    <?php
                                    }
                                    ?>
                    ...
                    <div class="flex-w flex-sb bo10 p-t-15 p-b-20">
                        ...
                        <div class="w-size20 w-full-sm">
                            <p class="s-text8 p-b-23">
                                Đơn hàng sẽ được giao đến địa chỉ của bạn sớm nhất ! Vui lòng kiểm tra địa chỉ trước khi xác nhận !
                            </p>
                            <!-- span class="s-text19">
                                Calculate Shipping
                                </span>
