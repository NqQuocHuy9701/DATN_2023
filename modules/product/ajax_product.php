					...
					<div class="flex-w">
						...
						<div class="rs2-select2 bo4 of-hidden w-size12 m-t-5 m-b-5 m-r-10">
							<select class="selection-2" name="sorting">
								<option>Price</option>
								<option>0.00 VND - 50.00 VND</option>
								<option>50.00 VND - 100.00 VND</option>
								<option>100.00 VND - 150.00 VND</option>
								<option>150.00 VND - 200.00 VND</option>
								<option>200.00+ VND</option>
