        ...
        <div class="container-menu-header">
            <div class="topbar">
                ...
                <div class="topbar-child2">
                    <span class="topbar-email">
                        <a href="mailto:ng.quochuy9701@gmail.com">ng.quochuy9701@gmail.com</a>
                    </span>
            ...
            <div class="wrap_header">
                ...
                <a href="index.php" class="logo">
                    <img src="imgs/logo/X shop.png" style=" max-height: 65px;" alt="IMG-LOGO">
                </a>
                <!-- Menu -->
                <div class="wrap_menu">
                    <nav class="menu">
                ...
                <div class="header-icons">
                    ...
                    ?>
                        ...
                        <a href="?mod=users&act=logout" class="ask"><i class="fa fa-sign-out" aria-hidden="true" title="logout" style="font-size: 20px; padding-left: 8px;cursor: pointer;"></i></a>
            ...
            <div class="wrap_header_mobile">
                ...
                <a href="index.php" class="logo-mobile">
                    <img src="imgs/logo/X shop.png" style="    max-height: 64px;" alt="IMG-LOGO">
                </a>
                <!-- Button show menu -->
